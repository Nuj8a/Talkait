        ...
        <div id="signup-container-modal" style="display: none;">
            <div class="signup-container">
                <form method="post" action="login.php">
                    ...
                    <input type="password" name="signup-password" id="signup-password" placeholder="Enter Password" onsubmit="checkLength()">
                    <label>Confirm Password :</label>
                    <input type="password" name="confirm-password" id="signup-password" placeholder="Enter Password">
